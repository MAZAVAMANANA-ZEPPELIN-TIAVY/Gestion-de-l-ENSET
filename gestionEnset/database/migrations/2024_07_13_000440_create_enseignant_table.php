...
class CreateEnseignantTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('enseignant', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_situation');
            $table->timestamps();
            ...
            $table->foreign('id_situation')->references('id')->on('situation')->onDelete('cascade');
        });
    }
    ...
    public function down(){
        Schema::table("enseignant", function(Blueprint $table){
            ...
            $table->dropConstrainedForeignId("id_grade");
            $table->dropConstrainedForeignId("id_situation");
        });
